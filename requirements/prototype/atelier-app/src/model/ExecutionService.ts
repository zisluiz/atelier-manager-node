...
export class ExecutionService {
    constructor(public service: Service, public hourValue: number, public instancedCloths: null | ClothInstance[], 
        public spendedTimes: SpendTime[], public revenues: Revenue[], public expenses: Expense[], public status: Status, public serviceReturned: boolean = false, public payed: boolean = false) {};
}